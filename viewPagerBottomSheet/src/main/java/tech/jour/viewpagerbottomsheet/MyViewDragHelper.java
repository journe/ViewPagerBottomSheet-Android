...
public class MyViewDragHelper {
     ...
     */
    public static MyViewDragHelper create(@NonNull ViewGroup forParent, @NonNull Callback cb) {
     ...
     * but {@link androidx.customview.widget.ViewDragHelper.Callback#tryCaptureView(View, int)} will not be asked permission to
     * capture this view.
     *
